...
"""
    ...
    def add_compile_cmds(self, cores=8, plat=None, synth_strat=None, impl_strat=None):
        ...
        if plat.project_mode:
            ...
            #self.add_tcl_cmd('launch_runs synth_1 -jobs %d' % cores, stage='synth')#lijian
            self.add_tcl_cmd('launch_runs synth_1 -jobs 16', stage='synth')
            ...
            # Implementation Commands
            #self.add_tcl_cmd('launch_runs impl_1 -jobs %d' % cores, stage='impl')#lijian
            self.add_tcl_cmd('launch_runs impl_1 -jobs 16', stage='impl')
