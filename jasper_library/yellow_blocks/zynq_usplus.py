...
class zynq_ultra_ps_e(zynq_usplus):
  def initialize(self):
    #self.add_source('spi_io_convert/spi_ioconvert.v')
  ...
  def gen_constraints(self):
    ...
    # cons.append(PortConstraint('SPI_0_0_io0_io',  'gpio', port_index=[0], iogroup_index=[2*32]))
