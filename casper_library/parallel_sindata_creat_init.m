...
reuse_block(blk, 'valid_out', 'built-in/outport', ...
'Position', [x+300 y x+300+x_width y+y_width], 'Port', '1');
add_line(blk, 'constant/1', 'valid_out/1');
...
for i = 1:channels
    ...
    add_line(blk, ['xilinx-in' num2str(i) '/1'], ['transform' num2str(i) '/1']);
    
    reuse_block(blk, ['out' num2str(i)], 'built-in/outport', ...
    'Position', [x+900 y x+900+x_width y+y_width], 'Port', num2str(i+1));
    add_line(blk, ['transform' num2str(i) '/1'], ['out' num2str(i) '/1']);
end
% 
