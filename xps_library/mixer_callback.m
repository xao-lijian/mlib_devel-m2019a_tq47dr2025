function [] = mixer_callback(gcb, tile, slice, arch)
  ...
  [gen, tile_arch, ~, ~] = get_rfsoc_properties(gcb);%20231021
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% elseif ~(strcmp(tile_arch, 'dual') && (tile > 229)) %indicates a dac%orig
  elseif (gen < 3 && ~(strcmp(tile_arch, 'dual') && (tile > 229)))  || (gen == 3)  %20231021
